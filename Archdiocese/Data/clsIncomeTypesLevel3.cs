...
public class clsIncomeTypesLevel3_List : List<clsIncomeTypesLevel3_Item>
{
    private string _connectionString = string.Empty;
    

    public clsIncomeTypesLevel3_List(string connectionString, ref Exception pEx)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "usp_GetIncomeTypesLevel3";
    ...
    private void Populate_Members(SqlDataReader data_reader)
    {
        ...
        if (data_reader.HasRows)
        {
            ...
            {
                clsIncomeTypesLevel3_Item tmp = new clsIncomeTypesLevel3_Item();
    ...
    public bool Add_Item(ref Exception pEx, clsIncomeTypesLevel3_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_InsertIncomeTypesLevel3";
            ...
            if (Save(ref pEx, cmd))
            {
                //this.Add(new clsIncomeTypesLevel3_Item(ID, description, accountNumber, parentID));
                conn.Close();
                return true;
            }
            else
    ...
    public bool Update_Item(ref Exception pEx, clsIncomeTypesLevel3_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_UpdateIncomeTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", obj.ID);
            cmd.Parameters.AddWithValue("@description", obj.description);
            cmd.Parameters.AddWithValue("@accountNumber", obj.accountNumber);
            cmd.Parameters.AddWithValue("@parentID", obj.parentID);
            if (Save(ref pEx, cmd))
            {
                foreach (clsIncomeTypesLevel3_Item Item in this)
                {
                    //if (Item.ID == ID)
                    //{
                    //    Item.ID = ID;
    ...
    public bool Delete_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_DeleteIncomeTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
    ...
    public bool Enable_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_EnableIncomeTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
    ...
    public bool Disable_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_DisableIncomeTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
...
public class clsIncomeTypesLevel3_Item
{
    private int _ID;
    ...
    public clsIncomeTypesLevel3_Item()
    {
        //Default constructor
    }

    public clsIncomeTypesLevel3_Item(int ID, string description, string accountNumber, int parentID)
    {
        _ID = ID;
