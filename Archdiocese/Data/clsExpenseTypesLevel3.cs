...
public class clsExpenseTypesLevel3_List : List<clsExpenseTypesLevel3_Item>
{
    private string _connectionString = string.Empty;
    

    public clsExpenseTypesLevel3_List(string connectionString, ref Exception pEx)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "usp_GetExpenseTypesLevel3";
    ...
    private void Populate_Members(SqlDataReader data_reader)
    {
        ...
        if (data_reader.HasRows)
        {
            ...
            {
                clsExpenseTypesLevel3_Item tmp = new clsExpenseTypesLevel3_Item();
    ...
    public bool Add_Item(ref Exception pEx, clsExpenseTypesLevel3_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_InsertExpenseTypesLevel3";
            ...
            if (Save(ref pEx, cmd))
            {
                //this.Add(new clsExpenseTypesLevel3_Item(ID, description, accountNumber, parentID));
                conn.Close();
                return true;
            }
            else
    ...
    public bool Update_Item(ref Exception pEx, clsExpenseTypesLevel3_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_UpdateExpenseTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", obj.ID);
            cmd.Parameters.AddWithValue("@description", obj.description);
            cmd.Parameters.AddWithValue("@accountNumber", obj.accountNumber);
            cmd.Parameters.AddWithValue("@parentID", obj.parentID);
            if (Save(ref pEx, cmd))
            {
                foreach (clsExpenseTypesLevel3_Item Item in this)
                {
                    //if (Item.ID == ID)
                    //{
                    //    Item.ID = ID;
    ...
    public bool Delete_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_DeleteExpenseTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
    ...
    public bool Enable_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_EnableExpenseTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
    ...
    public bool Disable_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_DisableExpenseTypesLevel3";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
...
public class clsExpenseTypesLevel3_Item
{
    private int _ID;
    ...
    public clsExpenseTypesLevel3_Item()
    {
        //Default constructor
    }

    public clsExpenseTypesLevel3_Item(int ID, string description, string accountNumber, int parentID)
    {
        _ID = ID;
