...
public class clsIncomeTypesLevel2_List : List<clsIncomeTypesLevel2_Item>
{
    private string _connectionString = string.Empty;
    

    public clsIncomeTypesLevel2_List(string connectionString, ref Exception pEx, int ID, string description, string accountNumber, int parentID)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "usp_GetIncomeTypesLevel2";
    ...
    private void Populate_Members(SqlDataReader data_reader)
    {
        ...
        if (data_reader.HasRows)
        {
            ...
            {
                clsIncomeTypesLevel2_Item tmp = new clsIncomeTypesLevel2_Item();
    ...
    public bool Add_Item(ref Exception pEx, clsIncomeTypesLevel2_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_InsertIncomeTypesLevel2";
            ...
            if (Save(ref pEx, cmd))
            {
                //this.Add(new clsIncomeTypesLevel2_Item(ID, description, accountNumber, parentID));
                conn.Close();
                return true;
            }
            else
    ...
    public bool Update_Item(ref Exception pEx, clsIncomeTypesLevel2_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_UpdateIncomeTypesLevel2";
            cmd.Parameters.AddWithValue("@ID", obj.ID);
            cmd.Parameters.AddWithValue("@description", obj.description);
            cmd.Parameters.AddWithValue("@accountNumber", obj.accountNumber);
            cmd.Parameters.AddWithValue("@parentID", obj.parentID);
            if (Save(ref pEx, cmd))
            {
                foreach (clsIncomeTypesLevel2_Item Item in this)
                {
                    //if (Item.ID == ID)
                    //{
                    //    Item.ID = ID;
    ...
    public bool Delete_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_DeleteIncomeTypesLevel2";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
    ...
    public bool Enable_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_EnableIncomeTypesLevel2";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
    ...
    public bool Disable_Item(ref Exception pEx, int ID)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "usp_DisableIncomeTypesLevel2";
            cmd.Parameters.AddWithValue("@ID", ID);
            if (Save(ref pEx, cmd))
            {
                conn.Close();
...
public class clsIncomeTypesLevel2_Item
{
    private int _ID;
    ...
    public clsIncomeTypesLevel2_Item()
    {
        //Default constructor
    }

    public clsIncomeTypesLevel2_Item(int ID, string description, string accountNumber, int parentID)
    {
        _ID = ID;
