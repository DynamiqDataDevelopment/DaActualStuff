...
public class clsTelephoneNumberTypes_List : List<clsTelephoneNumberTypes_Item>
{
    ...
    public clsTelephoneNumberTypes_List(string connectionString)
    {
    ...
    public bool Add_Item(ref Exception pEx, clsTelephoneNumberTypes_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
    ...
    public bool Update_Item(ref Exception pEx, clsTelephoneNumberTypes_Item obj)
    {
        SqlConnection conn = new SqlConnection((_connectionString));
        try
        {
    ...
    public bool Enable_Item(ref Exception pEx, int ID, bool enable)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = enable ? "usp_EnableTelephoneNumberTypes" : "usp_DisableTelephoneNumberTypes";
