...
{
    public partial class frmParishTypes : Form
    {
        public int _ID;
        public string _Description;
        public bool _isDeleted;
        public clsParishTypes_List _List = new clsParishTypes_List(Globals.DecryptString(Properties.Settings.Default.SqlConnectionString));
        public frmParishTypes()
        {
            InitializeComponent();
        }
        ...
        private void Save()
        {
            clsParishTypes_Item mcObject = new clsParishTypes_Item();
        ...
        private clsParishTypes_Item PrepareObject()
        {
            clsParishTypes_Item obj = new clsParishTypes_Item();
            obj.ID = _ID;
